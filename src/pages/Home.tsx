  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-10">
    ...
    <div className="w-full md:w-1/2 text-center md:text-left space-y-5">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 leading-snug">
        Your Trusted Partner in Home Loans — 
        <br className="hidden sm:block" />
        <span className="text-[#ED7A1C]"> Purchase or Refinance </span> with Confidence
      </h1>

      <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed">
        At <span className="font-semibold text-[#ED7A1C]">Karthik Mortgage</span>, we don’t just process loans — we build relationships. 
        Our mission is to simplify the mortgage process, offering tailored loan solutions that make homeownership 
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              With years of industry experience, we've helped countless clients secure the right financing — from first-time homebuyers to homeowners seeking smarter refinance options.
            </p>
            ...
            <div className="bg-[#FFF5E6] border-l-4 border-[#ED7A1C] p-6 rounded-r-lg">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-[#ED7A1C] mr-3 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Competitive rates and flexible loan programs.</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-[#ED7A1C] mr-3 flex-shrink-0 mt-0.5" />
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow border-t-4 border-[#ED7A1C]">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-bold text-gray-800 ml-4">Home Purchase Loans</h3>
              </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow border-t-4 border-[#ED7A1C]">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-bold text-gray-800 ml-4">Home Refinance Loans</h3>
              </div>
              <p className="text-gray-700 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">From application to closing, we're with you at every step — and even after.</p>
            </div>
          </div>
