      ...
      <section className="bg-gradient-to-br from-[#FFF5E6] to-[#FFE8CC] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-700 leading-relaxed">
            Use our mortgage calculator to estimate your monthly payments, compare scenarios, 
            and plan your budget with confidence. Adjust values below to see how each factor 
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  value={homePrice}
                  onChange={(e) => setHomePrice(Number(e.target.value))}
                  className="w-full mt-2 accent-[#ED7A1C]"
                />
              </div>
          ...
          <div>
            ...
            <div className="mt-6 bg-[#FFF5E6] p-6 rounded-lg border-l-4 border-[#ED7A1C]">
              <p className="text-sm text-gray-700 mb-4">
                <span className="font-semibold">Note:</span> These estimates are for informational purposes only and do not include property taxes, insurance, HOA fees, or PMI. Contact us for a personalized quote.
              </p>
              <a
                href="/contact"
      ...
      <section className="py-16 bg-gradient-to-br from-[#FFF5E6] to-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-700 mb-8 leading-relaxed">
            Our mortgage experts are here to help you find the best loan solution for your unique situation. 
            Get a personalized quote and pre-approval today.
          </p>
          <a
            href="/apply"
